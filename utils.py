...
def selectColumnLabels(data):
    features = data[[
        ...
        'G_PinkieRingAb', 'G_ThumbIJ', 'G_ThumbMPJ',
       'G_IndexPIJ', 'G_IndexMPJ', 'G_MiddlePIJ', 'G_MiddleMPJ', 'G_RingPIJ',
       'G_RingMPJ', 'G_PinkieMPJ', 'G_PinkiePIJ', 'G_PalmArch',
       'G_ThumbRotate', 'G_ThumbAb', 'G_MiddleIndexAb', 'G_RingMiddleAb',
       'tactile1', 'tactile2', 'tactile3', 'tactile4', 'tactile5', 'tactile6',
       'tactile7', 'tactile8', 'tactile9', 'tactile10', 'tactile11',
       'tactile12', 'tactile13', 'tactile14', 'tactile15', 'tactile16',
       'tactile17', 'tactile18', 'tactile19', 'tactile20', 'tactile21',
       'tactile22', 'tactile23', 'tactile24', 'tactile25', 'tactile26',
       'tactile27', 'tactile28', 'tactile29', 'tactile30', 'tactile31',
       'tactile32', 'tactile33', 'tactile34', 'tactile35', 'tactile36',
       'tactile37', 'tactile38', 'tactile39', 'tactile40', 'tactile41',
       'tactile42', 'tactile43', 'tactile44', 'tactile45', 'tactile46',
       'tactile47', 'tactile48', 'tactile49', 'tactile50', 'tactile51',
       'tactile52', 'tactile53', 'tactile54', 'tactile55', 'tactile56',
       'tactile57', 'tactile58', 'tactile59', 'tactile60', 'tactile61',
       'tactile62', 'tactile63', 'tactile64'
    ]]
...
class BaxterDataset(Dataset):
    ...
    def __init__(self):
        #filePathTrain = 'D:\\python_project\\transformer\\HDR-IL\\Simulation Code\\lift_primitive_data.csv'
        filePathTrain = 'D:\python_project\\transformer\graduation_project_il\csv file\short_right_hand.csv'
        # filePathTrain = '../Simulation Data/primitive data filtering 625 L.csv'

        self.coordinates = pd.read_csv(filePathTrain)
        #add new column "Prim" Prim表示机器人执行的动作类型
        # self.coordinates['Prim'] = self.coordinates.apply(lambda row: label_primitive(row), axis = 1)
        #0 代表例子中的旋转方向
        self.coordinates['Prim']=0
        self.columns, self.labels= selectColumnLabels(self.coordinates)##return robotic states
